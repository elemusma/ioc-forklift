...
<div class="wrap">
	...
	<h2><?php _e( 'Stack Slider 3d Image slider - Features', 'stack-slider-a-3d-imageslider' ); ?></h2><br />	
	...
	<style>
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Stack Slider 3d Image slider</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Stack Slider 3d Image slider</strong> and <strong>all other products</strong> with a single purchase.</p>
	   ...
	   <tbody>
			...
			<tr>
			<th>Image Title<span class="subtext">Show image title.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Image Caption<span class="subtext">Show image Caption.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Hide/Show Image Title Option<span class="subtext">Option to hide or show title.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Hide/Show Image Caption Option<span class="subtext">Option to hide or show caption.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Image link<span class="subtext">You can set image link.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			...
			<tr>
			<th>Slider Autoplay<span class="subtext">Option to slider autoplay or not.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			
			<tr>
			<th>Slider Speed<span class="subtext">You can set slider Speed.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>

			<tr>
			<th>Slider Autoplay Speed<span class="subtext">You can set slider Autoplay Speed.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			...
			<tr>
			<th>Slider Loop<span class="subtext">You can enable slider continuous loop mode.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Autoplay Stop On Last<span class="subtext">you can set autoplay will be stopped when it reaches last slide</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			
			<tr>
			<th>Depth Option<span class="subtext">You can set depth value to scale the left and right images.</span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Rotate Image<span class="subtext">You can set rotate value for image.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Stretch Image<span class="subtext">You can set value for stretch.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>	
			<th>Pagination<span class="subtext">Pagination enable/disable option </span></th>
			<td><i class="dashicons dashicons-yes"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Pagination Type<span class="subtext">You can set diffrent type of pagination.</span></th>
			<td>2</td>
			<td>2</td>
			</tr>
			<tr>
			<th>Navigation Theme Type <span class="subtext">Option to change navigation theme option.</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td>Blue, Light, Black</td>
			</tr>
			<tr>
